                ...
                <div className="referenzen-box">
                    <Link href="#">
                        <div className="referenzen-box-1">
                            <h2>Der Grieche Kamenz (Entwurf)</h2>
                        </div>
                    </Link>
                    <Link href="#">
                        <div className="referenzen-box-2">
                            <h2>DIW Bau GmbH</h2>
                        </div>
                    </Link>
                </div>
                <div className="referenzen-end">
                    <i class="far fa-sad-cry"></i>                    
                    <h2>Hier gibts leider nichts mehr!</h2>
                    <p>Sie wollen auch auf dieser Liste erscheinen? <Link href="/kontakt"><a>Kontaktieren Sie mich!</a></Link></p>
                </div>
            </div>
        </section>
